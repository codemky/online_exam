...
var contestDetailPage = {
    ...
    init: function (contest, questions) {
        ...
        if (contestDetailPage.data.questions[0].questionType == 0) {
            var start_difficulty = "";
            if (contestDetailPage.data.questions[0].difficulty == 1 )
                start_difficulty = '<i class="glyphicon glyphicon-star"></i>\n' +
                    '                    <i class="glyphicon glyphicon-star-empty"></i>\n' +
                    '                    <i class="glyphicon glyphicon-star-empty"></i>\n' +
                    '                    <i class="glyphicon glyphicon-star-empty"></i>\n' +
                    '                    <i class="glyphicon glyphicon-star-empty"></i>';
            if (contestDetailPage.data.questions[0].difficulty == 2 )
                start_difficulty = '<i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star-empty"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star-empty"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star-empty"></i>';
            if (contestDetailPage.data.questions[0].difficulty == 3 )
                start_difficulty = '<i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star-empty"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star-empty"></i>';
            if (contestDetailPage.data.questions[0].difficulty == 4 )
                start_difficulty = '<i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star-empty"></i>';
            if (contestDetailPage.data.questions[0].difficulty == 5 )
                start_difficulty = '<i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>';
            $('#currentQuetionDifficulty').html('本题难度系数:'+ start_difficulty  +'');
            ...
            $('#currentQuetionTitle').html('(填空)'+contestDetailPage.data.questions[0].content+'('+contestDetailPage.data.questions[0].score+'分)');
    ...
    targetQuestionAction: function (index) {
        ...
        if (contestDetailPage.data.questions[index].questionType == 0) {
            var start_difficulty = "";
            if (contestDetailPage.data.questions[index].difficulty == 1 )
                start_difficulty = '<i class="glyphicon glyphicon-star"></i>\n' +
                    '                    <i class="glyphicon glyphicon-star-empty"></i>\n' +
                    '                    <i class="glyphicon glyphicon-star-empty"></i>\n' +
                    '                    <i class="glyphicon glyphicon-star-empty"></i>\n' +
                    '                    <i class="glyphicon glyphicon-star-empty"></i>';
            if (contestDetailPage.data.questions[index].difficulty == 2 )
                start_difficulty = '<i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star-empty"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star-empty"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star-empty"></i>';
            if (contestDetailPage.data.questions[index].difficulty == 3 )
                start_difficulty = '<i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star-empty"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star-empty"></i>';
            if (contestDetailPage.data.questions[index].difficulty == 4 )
                start_difficulty = '<i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star-empty"></i>';
            if (contestDetailPage.data.questions[index].difficulty == 5 )
                start_difficulty = '<i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
                    '                            <i class="glyphicon glyphicon-star"></i>\n' +
    ...
    submittingContestAction: function () {
        ...
        var answerJsonStr = '';
        for (var i = 0; i < contestDetailPage.data.questions.length; i++) {
            if (contestDetailPage.data.questions[i].answer == '')
                answerJsonStr += '#';
